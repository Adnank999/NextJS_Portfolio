...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_zsvnm8s', 'template_hdz8dfl', form.current, 'Xl898hXMJBnoFcmHf')
        .then((result) => {
  ...
  return (
    ...
    <div className="lg:py-2 px-4 sm:px-8 md:px-20 lg:px-20 xl:px-32 h-screen mr-6 max-w-full md:max-w-screen-md border-cyan-500/50 border-solid border-2 rounded-lg">
        <h2 className="mb-4 mt-6 text-2xl tracking-tight font-bold text-center text-gray-900 dark:text-white">Contact Me</h2>
        
        <form ref={form} onSubmit={sendEmail} className ="space-y-8">
            <div>
                <label className ="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
                <input type="email" name="email" id="email" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-slate-200 dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light" placeholder="Your Email" required/>
            ...
            <div className ="sm:col-span-2">
                ...
                <textarea id="message" name="message" rows="6" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-slate-200 dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Leave a comment..."/>
            </div>
            <input 
            type="submit" 
            value="Send" 
