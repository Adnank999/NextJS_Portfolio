...
Command: npx gltfjsx@6.2.13 public/Space/scene.glb 
...
const SpaceEX = (props) => {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Space/scene.glb')
          ...
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              ...
              <group name="Icosphere_20" position={[-1.272, -0.641, 2.571]} rotation={[0.033, 0.439, 0.135]} scale={[0.631, 0.55, 0.451]}>
                <mesh name="mesh_17" geometry={nodes.mesh_17.geometry} material={materials.fire} />
              </group>
              <group name="Cylinder001_21" position={[-0.927, 0.54, 0.123]} rotation={[0.747, 0.559, 0.194]}>
                <mesh name="Object_40" geometry={nodes.Object_40.geometry} material={materials.moon} />
              </group>
              <group name="Sphere001_3" position={[-1.427, -3.203, -1.037]} rotation={[0.154, -0.885, -0.075]} scale={[47.439, 40.438, 50.615]}>
                <mesh name="Object_6" geometry={nodes.Object_6.geometry} material={materials.moon} />
              </group>
              ...
              <group name="Cube028_19" position={[-10.29, -0.362, -19.863]} rotation={[0.678, -0.398, 0.813]} scale={[5.017, 4.983, 3.263]}>
                <mesh name="Object_36" geometry={nodes.Object_36.geometry} material={materials.moon} />
              </group>
              <group name="Cylinder002_22" position={[-4.239, 1.916, -13.034]}>
                <mesh name="mesh_19" geometry={nodes.mesh_19.geometry} material={materials.smoke} />
              </group>
              <group name="Plane_24" position={[-22.772, -25.075, -21.01]} rotation={[0.61, -0.505, -0.988]} scale={37.932}>
                <mesh name="Object_44" geometry={nodes.Object_44.geometry} material={materials.spaceglow} />
              </group>
              <group name="Armature_93" position={[0, -0.731, 0]}>
                <group name="GLTF_created_0">
                  ...
                  <group name="scarf_91" />
                  <group name="torso_92" />
                  <skinnedMesh name="Object_57" geometry={nodes.Object_57.geometry} material={materials.spaceame} skeleton={nodes.Object_57.skeleton} />
                  <skinnedMesh name="Object_59" geometry={nodes.Object_59.geometry} material={materials.spaceame} skeleton={nodes.Object_59.skeleton} />
                  <skinnedMesh name="Object_67" geometry={nodes.Object_67.geometry} material={materials.spaceameface} skeleton={nodes.Object_67.skeleton} />
                  <skinnedMesh name="Object_69" geometry={nodes.Object_69.geometry} material={materials.outline} skeleton={nodes.Object_69.skeleton} />
...
useGLTF.preload('/Space/scene.glb')
